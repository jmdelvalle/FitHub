class GymsController < ApplicationController
  ...
  def results
    ...
    @gyms_results = client.spots_by_query("#{search} near #{@city}, NY", :types => "gym", :radius => 8000)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @gym.save
        format.html { redirect_to @gym, notice: 'Gym was successfully added.' }
  ...
  private
    ...
    def gym_params
      params.require(:gym).permit(:name, :address, :latitude, :longitude)
    end
end
