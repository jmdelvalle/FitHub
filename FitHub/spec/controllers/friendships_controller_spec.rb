  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved friendship as @friendship" do
        post :create, {:friendship => invalid_attributes}, valid_session
        expect(assigns(:friendship)).to be_a_new(Friendship)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested friendship" do
        friendship = Friendship.create! valid_attributes
        put :update, {:id => friendship.to_param, :friendship => new_attributes}, valid_session
        friendship.reload
    ...
    context "with invalid params" do
      it "assigns the friendship as @friendship" do
        friendship = Friendship.create! valid_attributes
        put :update, {:id => friendship.to_param, :friendship => invalid_attributes}, valid_session
        expect(assigns(:friendship)).to eq(friendship)
      end
